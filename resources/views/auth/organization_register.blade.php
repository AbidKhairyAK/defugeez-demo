...
@section('title', 'Organization Register Form')
...
<div class="form-group">
  ...
  {!! Form::email('email', null, ['class' => 'form-control '.$email['invalid'], 'id' => 'email']) !!}
  {!! $email['feedback'] !!}
</div>
  ...
  <div class="fileinput fileinput-new" data-provides="fileinput">
    ...
    <div>
      <span class="btn btn-outline-info btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
        {!! Form::file('logo_image', null, ['class' => 'form-control '.$logo_image['invalid'], 'id' => 'logo_image', 'required']) !!}
      </span>
